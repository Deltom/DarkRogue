...
Результат выберает группу подходящих результатов, изходя из тегов действий тебя и врага
А потом изходя из стат. переменных движений выбераются то что подходит и если в итоге, вариантов больше 1, вступает рандом
 */